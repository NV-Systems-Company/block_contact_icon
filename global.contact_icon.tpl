...
<div class="vka-wrapper">
	...
	<div class="vka-wheel">
		<!-- BEGIN: maps -->
		<a class="vka-action vka-action-1" href="{DATA.maps}" rel="nofollow" target="_blank" title="Tìm cửa hàng">
			<div class="vka-button vka-button-1"><i class="icon-cps-local"></i></div>
		</a>
		<!-- END: maps -->
		<!-- BEGIN: phone -->
		<a class="vka-action vka-action-2" href="tel:{DATA.phone}" rel="nofollow" title="Gọi trực tiếp">
			<div class="vka-button vka-button-2"><i class="icon-cps-phone"></i></div>
		</a>
		<!-- END: phone -->
		<!-- BEGIN: messenger -->
		<a class="vka-action vka-action-3" href="https://www.messenger.com/t/{DATA.messenger}" rel="nofollow" target="_blank" title="Chat Facebook">
			<div class="vka-button vka-button-3"><i class="icon-cps-facebook"></i></div>
		</a>
		<!-- END: messenger -->
		<!-- BEGIN: zalo -->
		<a class="vka-action vka-action-4" href="https://zalo.me/{DATA.zalo}" target="_blank" rel="nofollow" title="Chat Zalo">
